...
examples/output: src/monarch_kg_qc_schema/schema/monarch_kg_qc_schema.yaml
	mkdir -p $@
...
git-init:
	git init
git-add: .cruft.json
	git add .gitignore .github .cruft.json Makefile LICENSE *.md examples utils about.yaml mkdocs.yml poetry.lock project.Makefile pyproject.toml src/monarch_kg_qc_schema/schema/*yaml src/*/datamodel/*py src/data src/docs tests src/*/_version.py
